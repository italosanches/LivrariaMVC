            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GeneroId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GeneroNome = table.Column<string>(type: "varchar(50)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LivroId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LivroTitulo = table.Column<string>(type: "varchar(50)", nullable: false),
                    LivroDescricao = table.Column<string>(type: "varchar(100)", nullable: false),
                    LivroQuantidadePaginas = table.Column<int>(type: "int", nullable: false),
                    LivroDataPublicacao = table.Column<DateTime>(type: "datetime2", nullable: false),
